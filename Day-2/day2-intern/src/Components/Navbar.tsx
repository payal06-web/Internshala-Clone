                    ...
                    <div className="hidden md:flex items-center space-x-8"
                        ...
                        <div className="flex items-center bg-gray-100 rounded-full px-4 py-2">
                            ...
                            <input type="text"
                                ...
                                className="ml-2 bg-tranparent focus:outline-none text-sm w-48"
                            />
                        </div>
                    </div>
                {/* Auth Buttons */}
                    ...
                    {user ? (
                        <div className="relative flex">
                            <button className="flex items-center space-x-2 " onClick={() => setisprofiledropdown(!isprofiledropdown)}>
                                ...
                                {isprofiledropdown ? <ChevronUp size={16} className="text-gray-500"/> : <ChevronDown size={16} className="text-gray-500"/>}
                            </button>
                            <button
